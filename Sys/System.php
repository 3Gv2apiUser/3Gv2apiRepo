 ...
 * Class System
 */
class System extends \Sys\ServerComponent
{
	protected
		/**
	...
	public function createComponent($sComponentName) {
		...
		if (!class_exists($sComponentName, false))
		{
			// this is not in autoload at the moment but we could integrate it there
			// for simplicity I use this way now
			$sComponentFilename = SYSTEM_MAINDIR. "classes".DIRECTORY_SEPARATOR."Component.".$sComponentName.".class.php";
			if (file_exists($sComponentFilename))
				require_once($sComponentFilename);
			else
				$sComponentName = "NULL";
		}
